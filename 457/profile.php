		...
		<!-- Small boxes (Stat box) -->
		  <div class="row">
			...
			<div class="col-sm-8">
				...
				$query2 = "SELECT b.ISBN, b.title, b.price, p.quantity FROM books  as b, purchase as p 
				...
				while ($row = mysql_fetch_array($result2, MYSQL_ASSOC)) {
					?>
						<tr>
							...
							<td><a href="book.php?ISBN=<?php echo $row['ISBN'];?>"><?php echo $row['title']?></a></td>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							Amount till date = <?php echo $totalPrice ?> </br>
						</div>
					</div>
				</div>
						...
						<div class="panel-body">
							<a href="reset.php" class="btn btn-primary btn-flat pull-left"> Clear System </a>
			  				<form action="#" method="POST">
			  					<input type="hidden" name="fileName" value="profile.php">
